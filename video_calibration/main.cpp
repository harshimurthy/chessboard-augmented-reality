...
//title of the explaination of this program
static void help()
{
...
//Setting is the class for how to deal with the xml file
class Settings
{
public:
...
int main(int argc, char* argv[])
{
    ...
    //! [get_input]get the next image from the image list, camera or video file
    for(;;)
    {
        Mat view;
                                        ...
                                        vector<float>& perViewErrors)
{
    ...
    cout<<"Total error is :"<<totalErr<<endl;
...
//! [board_corners]
////////////////
//find cameraMatrix, distCoeffs, reprojErrs, totalAvgErr
...
//        C++: void calibrationMatrixValues(InputArray cameraMatrix, Size imageSize, double apertureWidth, double apertureHeight, double& fovx, double& fovy, double& focalLength, Point2d& principalPoint, double& aspectRatio)¶
        cout<<"focal length :"<<cameraMatrix.at<double>(0,0)<<endl;
        ...
        Point2d principalPoint1(cameraMatrix.at<double>(0,2), cameraMatrix.at<double>(1,2));
        Point2d principalPoint;
        cout<<"Principal"<<principalPoint1<<endl;
	cout<<"Distortion :"<<distCoeffs<<endl;//--
        
        double fovx,fovy;
        double aspectRatio = cameraMatrix.at<double>(0,0)/cameraMatrix.at<double>(1,1);
        //cout<<"df"<<endl;
        cout<<"aspect Ratio"<<aspectRatio<<endl;
        cv:: calibrationMatrixValues(cameraMatrix, imageSize, 1.0, 1.0, fovx, fovy, cameraMatrix.at<double>(0,0), principalPoint, aspectRatio);
        cout<<"fovx:"<<fovx<<endl;
        cout<<"fovy"<<fovy<<endl;
        
        cout<<"Principal Value:"<<principalPoint<<endl;
    ...
    totalAvgErr = computeReprojectionErrors(objectPoints, imagePoints, rvecs, tvecs, cameraMatrix,
     ...
     cout<<"Total avergae error is:"<<totalAvgErr<<endl;
